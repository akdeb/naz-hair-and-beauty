...
export default function Home() {
  return <div className="flex justify-center items-center h-screen">This website is currently unavailable due to unpaid services. Please contact the administrator to restore access.</div>
  // return (
